...
from corpochain.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from corpochain.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from corpochain.types.weight_proof import (
    RecentChainData,
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="corpochain_beacon_weight_proof_handler_executor_shutdown_trigger")
