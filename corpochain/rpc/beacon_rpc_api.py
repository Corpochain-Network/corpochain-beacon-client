...
from corpochain.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR
from corpochain.beacon.beacon import Beacon
from corpochain.rpc.rpc_server import Endpoint, EndpointResult
...
from corpochain.util.ints import uint32, uint64, uint128
from corpochain.util.log_exceptions import log_exceptions
from corpochain.util.ws_message import WsRpcMessage, create_payload_dict


class BeaconRpcApi:
    def __init__(self, service: Beacon) -> None:
        self.service = service
        self.service_name = "corpochain_beacon"
