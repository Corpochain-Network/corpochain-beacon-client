...
from corpochain.plotting.util import PlotInfo, parse_plot_info
from corpochain.protocols import harvester_protocol
from corpochain.protocols.farmer_protocol import FarmingInfo
from corpochain.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from corpochain.util.ints import uint8, uint32, uint64
from corpochain.util.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSCorpochainConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSCorpochainConnection
    ) -> None:
        """
