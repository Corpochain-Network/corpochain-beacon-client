...
from corpochain.rpc.beacon_rpc_api import BeaconRpcApi
...
from corpochain.util.task_timing import maybe_manage_task_instrumentation
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("CORPOCHAIN_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_corpochain_loop_policy", True):
            target_peer_count = None
