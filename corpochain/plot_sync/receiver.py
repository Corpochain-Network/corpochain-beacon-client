...
from corpochain.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from corpochain.plot_sync.exceptions import (
...
from corpochain.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from corpochain.plotting.util import HarvestingMode
...
from corpochain.server.outbound_message import make_msg
...
from corpochain.util.misc import get_list_or_len
...
class Receiver:
    _connection: WSCorpochainConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSCorpochainConnection:
