...
from corpochain.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from corpochain.plot_sync.util import Constants
from corpochain.plotting.manager import PlotManager
from corpochain.plotting.util import HarvestingMode, PlotInfo
...
from corpochain.util.generator_tools import list_to_batches
from corpochain.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSCorpochainConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSCorpochainConnection) -> None:
