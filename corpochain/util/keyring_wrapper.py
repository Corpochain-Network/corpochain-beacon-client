...
from corpochain.util.file_keyring import FileKeyring
...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ corpochain passphrase set # all the cool kids are doing it!"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from corpochain.util.keychain import supports_os_passphrase_storage
