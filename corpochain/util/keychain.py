...
DEFAULT_USER = f"user-corpochain-{CURRENT_KEY_VERSION}"  # e.g. user-corpochain-3.0
DEFAULT_SERVICE = f"corpochain-{DEFAULT_USER}"  # e.g. corpochain-user-corpochain-3.0
MAX_KEYS = 100
