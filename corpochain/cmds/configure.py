...
from corpochain.util.config import lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                net_introducer = "introducer.testnet.corpochain.pl"
                net_dns_introducer = "dns-introducer.testnet.corpochain.pl"
                net_bootstrap_peers = ["node.testnet.corpochain.pl"]
                net = "testnet"

            elif testnet == "false" or testnet == "f":
                print("Setting Mainnet")
                net_introducer = "introducer.mainnet.corpochain.pl"
                net_dns_introducer = "dns-introducer.mainnet.corpochain.pl"
                net_bootstrap_peers = ["node.mainnet.corpochain.pl"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running corpochain services for changes to take effect")
