...
from corpochain.cmds.cmds_util import get_any_service_client
...
from corpochain.util.misc import format_bytes, format_minutes
from corpochain.util.network import is_localhost

SECONDS_PER_BLOCK = (12 * 3600) / 4608
