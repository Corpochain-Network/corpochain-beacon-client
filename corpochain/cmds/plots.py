...
from corpochain.plotting.util import add_plot_directory, validate_plot_size

log = logging.getLogger(__name__)


def show_plots(root_path: Path):
    from corpochain.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from corpochain.plotting.create_plots import create_plots, resolve_plot_keys
    from corpochain.plotting.util import Params
...
def check_cmd(
    ...
    from corpochain.plotting.check_plots import check_plots
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from corpochain.plotting.util import remove_plot_directory
