...
from corpochain.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
from corpochain.protocols import timelord_protocol
...
from corpochain.timelord.iters_from_block import iters_from_block
from corpochain.timelord.timelord_state import LastState
from corpochain.timelord.types import Chain, IterationType, StateType
...
from corpochain.types.blockchain_format.slots import (
...
from corpochain.util.config import process_config_start_method
from corpochain.util.ints import uint8, uint16, uint32, uint64, uint128
...
class Timelord:
    ...
    async def on_connect(self, connection: WSCorpochainConnection):
        pass
