...
from corpochain.seeder.crawl_store import CrawlStore
from corpochain.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: WSCorpochainConnection):
    ...
    async def new_peak(self, request: beacon_protocol.NewPeak, peer: WSCorpochainConnection):
        try:
            peer_info = peer.get_peer_info()
